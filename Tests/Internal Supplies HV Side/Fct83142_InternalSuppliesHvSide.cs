namespace Program
{
    ...
    {
        public Fct83142_InternalSuppliesHvSide(int site, SiteManager siteManager) : base(site, siteManager)
        {
        }
        ...
        protected override List<TestItem> TestItems { get; set; } = new List<TestItem>
        {
            ...
            new TestItem { Descriptor = "FCT142008", Remark = "Vcc_4503TU (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP3x2403TU"), new TestPoint("TP19X4503TU") }, Minimal = 17.3, Nominal = 18, Maximal = 18.7, Unit = "V" },
            new TestItem { Descriptor = "FCT142009", Remark = "Vneg_4503TU (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP12x2403TU"), new TestPoint("TP19X4503TU") }, Minimal = -3.55, Nominal = -3.5, Maximal = -3.4, Unit = "V" },

            new TestItem { Descriptor = "FCT142010", Remark = "Vcc_4503TV (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP3x2403TV"), new TestPoint("TP19X4503TV") }, Minimal = 17.3, Nominal = 18, Maximal = 18.7, Unit = "V" },
            new TestItem { Descriptor = "FCT142011", Remark = "Vneg_4503TV (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP12x2403TV"), new TestPoint("TP19X4503TV") }, Minimal = -3.55, Nominal = -3.5, Maximal = -3.4, Unit = "V" },

            new TestItem { Descriptor = "FCT142012", Remark = "Vcc_4503TW (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP3x2403TW"), new TestPoint("TP19X4503TW") }, Minimal = 17.3, Nominal = 18, Maximal = 18.7, Unit = "V" },
            new TestItem { Descriptor = "FCT142013", Remark = "Vneg_4503TW (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP12x2403TW"), new TestPoint("TP19X4503TW") }, Minimal = -3.55, Nominal = -3.5, Maximal = -3.4, Unit = "V" },

            new TestItem { Descriptor = "FCT142014", Remark = "Vcc_4503BU (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP3x2403BU"), new TestPoint("TP19X4503BU") }, Minimal = 17.3, Nominal = 18, Maximal = 18.7, Unit = "V" },
            new TestItem { Descriptor = "FCT142015", Remark = "Vneg_4503BU (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP12x2403BU"), new TestPoint("TP19X4503BU") }, Minimal = -3.55, Nominal = -3.5, Maximal = -3.4, Unit = "V" },

            new TestItem { Descriptor = "FCT142016", Remark = "Vcc_4503BV (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP3x2403BV"), new TestPoint("TP19X4503BV") }, Minimal = 17.3, Nominal = 18, Maximal = 18.7, Unit = "V" },
            new TestItem { Descriptor = "FCT142017", Remark = "Vneg_4503BV (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP12x2403BV"), new TestPoint("TP19X4503BV") }, Minimal = -3.55, Nominal = -3.5, Maximal = -3.4, Unit = "V" },

            new TestItem { Descriptor = "FCT142018", Remark = "Vcc_4503BW (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP3x2403BW"), new TestPoint("TP19X4503BW") }, Minimal = 17.3, Nominal = 18, Maximal = 18.7, Unit = "V" },
            new TestItem { Descriptor = "FCT142019", Remark = "Vneg_4503BW (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP12x2403BW"), new TestPoint("TP19X4503BW") }, Minimal = -3.55, Nominal = -3.5, Maximal = -3.4, Unit = "V" },
            ...
            new TestItem { Descriptor = "FCT142032", Remark = "GateTopPhaU (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP14x4503TU"), new TestPoint("TP3X2403TU") }, Minimal = -23.0, Nominal = -21.0, Maximal = -20.0, Unit = "V" },
            new TestItem { Descriptor = "FCT142034", Remark = "GateTopPhaV (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP14x4503TV"), new TestPoint("TP3X2403TV") }, Minimal = -23.0, Nominal = -21.0, Maximal = -20.0, Unit = "V" },
            new TestItem { Descriptor = "FCT142036", Remark = "GateTopPhaW (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP14x4503TW"), new TestPoint("TP3X2403TW") }, Minimal = -23.0, Nominal = -21.0, Maximal = -20.0, Unit = "V" },

            // HS Set To 0 LS Set to 1
            new TestItem { Descriptor = "FCT142044", Remark = "GateBotmPhaU (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP14x4503BU"), new TestPoint("TP3X2403BU") }, Minimal = -23.0, Nominal = -21.0, Maximal = -20.0, Unit = "V" },
            new TestItem { Descriptor = "FCT142046", Remark = "GateBotmPhaV (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP14x4503BV"), new TestPoint("TP3X2403BV") }, Minimal = -23.0, Nominal = -21.0, Maximal = -20.0, Unit = "V" },
            new TestItem { Descriptor = "FCT142048", Remark = "GateBotmPhaW (Voltage)", TestPoints = new List<TestPoint> { new TestPoint("TP14x4503BW"), new TestPoint("TP3X2403BW") }, Minimal = -23.0, Nominal = -21.0, Maximal = -20.0, Unit = "V" },
        ...
        protected override void RunTest(TestEnv<UserFlagPurpose, PmxPurpose> testEnvironment, TestParameters parameters)
        {
            ...
            //    .SetStimuli(new StimulusConfig(StimulusId.DRI1, 0.0, 0.04, StimulusConnectionPoint.ABUS1, StimulusConnectionPoint.ABUS4))
            ...
            //               .DisconnectTps(Abus.ABUS1)
            //               .DisconnectTps(Abus.ABUS4)
            // );
